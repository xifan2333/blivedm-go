...
// OnInteractWord 添加旧版 INTERACT_WORD（JSON）事件处理器
...
// OnInteractWordV2 添加 INTERACT_WORD_V2（protobuf）事件处理器，含进房/关注/分享/点赞等
...
func (c *Client) Handle(p packet.Packet) {
	...
	case packet.Notification:
		...
		// 新版进房/关注等互动（data.pb base64 protobuf）
